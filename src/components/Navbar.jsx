...
const Navbar = forwardRef((_, ref) => {
  ...
  return (
    <nav
      ref={ref}
      className="fixed top-10 left-0 w-full flex justify-between lg:justify-center px-8 lg:px-12 z-50 gap-3 transition-all duration-700"
    >
      {/* Logo */}
      <div
        className={`flex items-center justify-center w-10 h-10 shadow-md hover:scale-105 transition-transform duration-300 
